...
$passwordlama = (isset($_POST['passwordlama'])) ? md5(htmlspecialchars($_POST['passwordlama'])) : "";
$passwordbaru = (isset($_POST['passwordbaru'])) ? md5(htmlspecialchars($_POST['passwordbaru'])) : "";
$repasswordbaru = (isset($_POST['repasswordbaru'])) ? md5(htmlspecialchars($_POST['repasswordbaru'])) : "";

if (!empty($_POST["ubah_password_validate"])) {
    $query = mysqli_query($conn, "SELECT * FROM tb_user WHERE username = '$_SESSION[username_decafe]' && password =            
    '$passwordlama'");
